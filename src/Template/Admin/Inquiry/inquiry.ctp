            ...
            <div class="box-body">
              <div class="row">
                <div class="col-xs-12"> 
                    ...
                    <li ng-click="getUnread()" class="test-class active"><a id="unread" style="border-radius:0px;"  class="deco-none red-class" href="#resp-tab1"> Unread(<span>{{unreadlength}}</span>)</a></li>
                    <li ng-click="getAll()"  class="test-class"><a id= "inbox" class="deco-none red-class" style="border-radius:0px;"  href="#resp-tab2">Inbox(<span>{{inboxlength}}</span>)</a></li>
                     <li ng-click="getReplied()" class="test-class"><a id="replied" class="deco-none red-class" style="border-radius:0px;"  href="#resp-tab2">Replied(<span>{{repliedlength}}</span>)</a></li>
                  </ul>
                </div>
              </div>

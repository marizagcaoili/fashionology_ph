...
<div style='height:120px;margin-top: 50px;border-top:1px solid;
background: #111;color:#fff;'>
<ul style='width:70%;position: relative;left:60px;top:40px;'>

   <a href='/terms/conditions' target='_self' style='font-family: Moon;font-size: 
   16px;color:#fff;'><li style='display:inline-block;margin-right:24px;margin-top:16px;list-style: none;'>Copyright Infringement</li></a>
   <a href='/terms/conditions' target='_self' style='font-family: Moon;font-size: 
   16px;color:#fff;'><li style='display:inline-block;margin-right:24px;margin-top:14px;list-style: none;'>About Privacy</li></a>
   <a href='/terms/conditions' target='_self' style='font-family: Moon;font-size: 
   16px;color:#fff;'><li style='display:inline-block;margin-right:24px;margin-top:16px;list-style: none;'>Return Policy</li></a>
</ul>
<!-- 
<p style='font-family: Moon;font-size: 16px;position: relative;top:50px;left:90px;'>&copy; 2016</p> -->
</div>
...
<?php include LAYOUT_DIR . 'front-itemmodal.ctp'; ?>

     <ul class="sidebar-menu">
        ...
        <li><a target="_self" href="/admin/dashboard"><i class="fa fa-dashboard"></i>  <span>Dashboard</span></a></li>
         <li><a target="_self" href="/admin/order"><i class="fa fa-shopping-cart"></i>  <span>Orders</span></a></li>
         <li><a target="_self" href="/admin/inquiry"><i class="fa fa-envelope"></i>  <span>Inquiries</span></a></li>
<!--          <li><a target="_self" href="/admin/dashboard"><i class="fa fa-comments"></i>  <span>Feedbacks</span></a></li> -->
